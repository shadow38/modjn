...
public enum ModbusExceptionCode {
	...
	/**
	 * Get the modbus exception code
	 * @param code modbus exception code to find
	 * @return ModbusExceptionCode found, null otherwise
	 */
	public static ModbusExceptionCode getByCode(short code)
	{
		for (ModbusExceptionCode exceptionCode : values())
		{
			if (code == exceptionCode.getCode())
			{
